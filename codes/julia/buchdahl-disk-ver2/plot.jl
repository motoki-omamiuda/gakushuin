...
# 0.5 plot
# ================================
# a_list_00, b_list_00 = read_txt(format("./data/{:.1f}/{:d}-{:d}-00.txt", A, DEGREE, equator_count))
# plt = plot_closed_curve(plt, a_list_00, b_list_00, equator_count, "blue")
# a_list_01, b_list_01 = read_txt(format("./data/{:.1f}/{:d}-{:d}-01.txt", A, DEGREE, equator_count))
# plt = plot_closed_curve(plt, a_list_01, b_list_01, equator_count, "blue")
# plot!(
#     plt,
#     [b_list_00[1] * sin(a_list_00[1]), b_list_01[1] * sin(a_list_01[1])],
#     [b_list_00[1] * cos(a_list_00[1]), b_list_01[1] * cos(a_list_01[1]), ],
#     color="blue"
# )
# plot!(
#     plt,
